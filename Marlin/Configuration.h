...
#define STRING_CONFIG_H_AUTHOR "(cristobal, EnderSKR3)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 2 //btt skr mini e3 v3.0
 ...
 */
#define BAUDRATE 1250000 //btt skr mini e3 v3.0
...
//#define BAUDRATE_2 250000   // Para pantalla MKS TFT32_L V3.0
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //btt skr mini e3 v3.0
#define Y_DRIVER_TYPE  TMC2209 //btt skr mini e3 v3.0
#define Z_DRIVER_TYPE  TMC2209 //btt skr mini e3 v3.0
...
#define E0_DRIVER_TYPE TMC2209 //btt skr mini e3 v3.0
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // BLTouch: invertir logica (true para este sensor)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 200 }  // Ender 3: prueba con 1000 en E
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 }  // Ender 3 safe defaults
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 }  // Ender 3 conservative
 ...
 */
#define DEFAULT_ACCELERATION          1000   // X, Y, Z and E acceleration for printing moves (Ender 3)
...
#define PROBING_MARGIN 20  // Mayor distancia desde bordes para seguridad

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (100*60)  // 100 mm/min para BLTouch

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (2*60)  // 2 mm/min para BLTouch (más lento que endstop)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2)  // 1 mm/min muy preciso
...
#define AUTO_BED_LEVELING_BILINEAR  // Recomendado para Ender 3 con BLTouch
...
#define ENABLE_LEVELING_AFTER_G28  // Aplicar leveling automáticamente después de G28
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5       // Ender 3: Grilla 4x4 para mejor precision
 ...
 */
#define SDSUPPORT // BTT SKR Mini E3 V3.0 tiene lector de SD
